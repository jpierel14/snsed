...
seds=snsedextend.extendCC(typeColors,curveDict,snType[0],outFileLoc=os.path.join('/Users','jpierel','rodney','SED_Repository','Type_'+snType[0]),sedlist=sedlist,zpsys='Vega',verbose=True,medianColor=avgColor)
    #snsedextend.extendNon1a(colorTable,sedlist='SDSS-0 13449.SED',verbose=True)
