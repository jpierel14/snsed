...
b_wave,b_trans=np.loadtxt(os.path.join(dir,'data','bands','bBand','tophatB.dat'),unpack=True)
sncosmo.registry.register(sncosmo.Bandpass(b_wave,b_trans,name='tophatB'),force=True)

v_wave,v_trans=np.loadtxt(os.path.join(dir,'data','bands','vBand','tophatV.dat'),unpack=True)
sncosmo.registry.register(sncosmo.Bandpass(v_wave,v_trans,name='tophatV'),force=True)

r_wave,r_trans=np.loadtxt(os.path.join(dir,'data','bands','rBand','tophatR.dat'),unpack=True)
sncosmo.registry.register(sncosmo.Bandpass(r_wave,r_trans,name='tophatR'),force=True)

i_wave,i_trans=np.loadtxt(os.path.join(dir,'data','bands','iBand','tophatI.dat'),unpack=True)
sncosmo.registry.register(sncosmo.Bandpass(i_wave,i_trans,name='tophatI'),force=True)

j_wave,j_trans=np.loadtxt(os.path.join(dir,'data','bands','jBand','tophatJ.dat'),unpack=True)
sncosmo.registry.register(sncosmo.Bandpass(j_wave,j_trans,name='tophatJ'),force=True)

h_wave,h_trans=np.loadtxt(os.path.join(dir,'data','bands','hBand','tophatH.dat'),unpack=True)
